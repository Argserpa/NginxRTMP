...
def fetch_rtmp_stats():
    ...
    for app_node in root.findall(".//application"):
        ...
        for stream_node in app_node.findall(".//stream"):
            ...
            # bw_in y bw_out vienen expresados en bits/s en la especificación de nginx-rtmp;
            # se dividen entre 8 para obtener bytes/s
...
def build_metrics(stats):
    ...
    # Sin streams activos, las métricas se emiten igualmente para que Grafana
